...
const modelCategories: ModelCategory[] = [
  {
    ...
    openrouterModels: [
      ...
      },
      {
        ...
        description: "Gemini 2.0 Flash Exp, free tier",
      },
    ],
  },
  {
...
export function SettingsDialog({
  ...
  const handleProviderChange = (provider: APIProvider) => {
    ...
    if (provider === "openai") {
      ...
      setExtractionModel("deepseek/deepseek-r1-0528:free");
      setSolutionModel("deepseek/deepseek-r1-0528:free");
      setDebuggingModel("deepseek/deepseek-r1-0528:free");
    }
  };
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <div className="flex flex-col">
                    ...
                    <p className="text-xs text-white/60">OpenRouter models</p>
                  </div>
                </div>
              </div>
            </div>
              ...
              {apiProvider === "openai" ? (
                ...
                <>
                  ...
                  <p className="text-xs text-white/60 mb-1">
                    ...
                    <button
                      onClick={() =>
                        openExternalLink("https://openrouter.ai/api-keys")
                      }
                      className="text-blue-400 hover:underline cursor-pointer"
                    >
                      API Keys
